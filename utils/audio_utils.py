...
def midi_to_wav(midi_path: str, wav_path: str, soundfont: str = '/usr/share/sounds/sf2/FluidR3_GM.sf2') -> None:
    logging.info(f"[AudioUtils] Converting {midi_path} to WAV at {wav_path} using soundfont {soundfont}.")
    ...
    fs.delete()
    logging.info(f"[AudioUtils] WAV file created at {wav_path}.")
